...
const directory = path_1.default.dirname(__filename);
// (async () => {
...
server.get('/generate/image', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (description.length === 0)
        return res.send({ message: "Não tem nenhum registro para hoje." });
    // const fileName = await generateImage(convertDescriptionToArray(description)
    // );
    // let absPath = path.join(__dirname, '/result/', fileName);
